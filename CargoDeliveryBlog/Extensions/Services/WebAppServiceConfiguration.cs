...
using CargoDeliveryBlog.Middleware;
...
public static class WebAppServiceConfiguration
{
    public static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddCorsService("CargoDeliveryBlogCorsPolicy", builder.Environment);
        builder.OpenTelemetryRegistration(builder.Configuration, "CargoDeliveryBlog");
        ...
        // registers all services that inherit from your base service interface - ICargoDeliveryBlogScopedService
    ...
    private static void AddBoundaryServices(this IServiceCollection services, params Assembly[] assemblies)
    {
        ...
        foreach (var assembly in assemblies)
        {
            var rules = assembly.GetTypes()
                .Where(x => !x.IsAbstract && x.IsClass && x.GetInterface(nameof(ICargoDeliveryBlogScopedService)) == typeof(ICargoDeliveryBlogScopedService));
