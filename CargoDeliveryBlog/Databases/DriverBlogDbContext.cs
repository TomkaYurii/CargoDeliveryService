namespace CargoDeliveryBlog.Databases;

using CargoDeliveryBlog.Domain;
using CargoDeliveryBlog.Databases.EntityConfigurations;
...
public sealed class DriverBlogDbContext : DbContext
{
    private readonly ICurrentUserService _currentUserService;
    private readonly IMediator _mediator;
    private readonly IDateTimeProvider _dateTimeProvider;

    public DriverBlogDbContext(
        DbContextOptions<DriverBlogDbContext> options, ICurrentUserService currentUserService, IMediator mediator, IDateTimeProvider dateTimeProvider) : base(options)
    {
