namespace CargoOrderingService.Extensions.Services;

using CargoOrderingService.Middleware;
...
public static class WebAppServiceConfiguration
{
    public static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddCorsService("CargoOrderingServiceCorsPolicy", builder.Environment);
        builder.OpenTelemetryRegistration(builder.Configuration, "CargoOrderingService");
        ...
        // registers all services that inherit from your base service interface - ICargoOrderingServiceScopedService
    ...
    private static void AddBoundaryServices(this IServiceCollection services, params Assembly[] assemblies)
    {
        ...
        foreach (var assembly in assemblies)
        {
            var rules = assembly.GetTypes()
                .Where(x => !x.IsAbstract && x.IsClass && x.GetInterface(nameof(ICargoOrderingServiceScopedService)) == typeof(ICargoOrderingServiceScopedService));
