...
public class GetDeliveryListTests : TestBase
{
    [Fact]
    public async Task get_delivery_list_returns_success_using_valid_auth_credentials()
    {
        // Arrange
        ...
        // Act
        var result = await FactoryClient.GetRequestAsync(ApiRoutes.Deliveries.GetList);
