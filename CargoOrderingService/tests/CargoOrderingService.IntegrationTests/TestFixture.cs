namespace CargoOrderingService.IntegrationTests;

using CargoOrderingService.Extensions.Services;
using CargoOrderingService.Databases;
using CargoOrderingService.Resources;
using CargoOrderingService.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.CargoOrderingServiceKey] = connection;
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<OrderingContext>()
            ...
            .Options;
        var context = new OrderingContext(options, null, null, null);
