...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<OrderingContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<OrderingContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<OrderingContext, Task<T>> action)
