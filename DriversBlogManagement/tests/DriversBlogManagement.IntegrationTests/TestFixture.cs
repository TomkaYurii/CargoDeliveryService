namespace DriversBlogManagement.IntegrationTests;
...
using DriversBlogManagement.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.DriversBlogManagementKey] = connection;
    ...
    {
        var options = new DbContextOptionsBuilder<BlogManagementContext>()
            .UseSqlServer(connectionString)
            .Options;
        var context = new BlogManagementContext(options, null, null, null);
