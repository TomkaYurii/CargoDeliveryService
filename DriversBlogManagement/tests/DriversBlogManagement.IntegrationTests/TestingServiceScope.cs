...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<BlogManagementContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<BlogManagementContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<BlogManagementContext, Task<T>> action)
