...
public class GetAllLikesTests : TestBase
{
    [Fact]
    public async Task get_all_likes_returns_success_using_valid_auth_credentials()
    {
        // Arrange
        ...
        // Act
        var result = await FactoryClient.GetRequestAsync(ApiRoutes.Likes.GetAll);
