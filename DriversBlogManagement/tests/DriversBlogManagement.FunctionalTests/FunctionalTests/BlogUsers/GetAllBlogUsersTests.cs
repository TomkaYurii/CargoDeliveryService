...
public class GetAllBlogUsersTests : TestBase
{
    [Fact]
    public async Task get_all_blogusers_returns_success_using_valid_auth_credentials()
    {
        // Arrange
        ...
        // Act
        var result = await FactoryClient.GetRequestAsync(ApiRoutes.BlogUsers.GetAll);
