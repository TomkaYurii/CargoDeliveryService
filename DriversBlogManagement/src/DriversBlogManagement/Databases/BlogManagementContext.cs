namespace DriversBlogManagement.Databases;

using DriversBlogManagement.Domain;
using DriversBlogManagement.Databases.EntityConfigurations;
...
public sealed class BlogManagementContext : DbContext
{
    ...
    public DbSet<PostAboutDriver> PostAboutDrivers { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        */
        ...
        modelBuilder.ApplyConfiguration(new PostAboutDriverConfiguration());
        modelBuilder.ApplyConfiguration(new CommentConfiguration());
        modelBuilder.ApplyConfiguration(new BlogUserConfiguration());
