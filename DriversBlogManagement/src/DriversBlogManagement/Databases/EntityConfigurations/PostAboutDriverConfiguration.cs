namespace DriversBlogManagement.Databases.EntityConfigurations;

using DriversBlogManagement.Domain.PostAboutDrivers;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

public sealed class PostAboutDriverConfiguration : IEntityTypeConfiguration<PostAboutDriver>
{
    /// <summary>
    /// The database configuration for PostAboutDrivers. 
    /// </summary>
    public void Configure(EntityTypeBuilder<PostAboutDriver> builder)
    {
