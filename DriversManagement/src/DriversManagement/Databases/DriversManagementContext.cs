namespace DriversManagement.Databases;

using DriversManagement.Domain;
using DriversManagement.Databases.EntityConfigurations;
...
public sealed class DriversManagementContext : DbContext
{
    ...
    public DriversManagementContext(
        DbContextOptions<DriversManagementContext> options, ICurrentUserService currentUserService, IMediator mediator, IDateTimeProvider dateTimeProvider) : base(options)
    {
