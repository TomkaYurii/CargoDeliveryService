...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.DriversManagementKey] = connection;
    ...
    {
        var options = new DbContextOptionsBuilder<DriversManagementContext>()
            .UseSqlServer(connectionString)
            .Options;
        var context = new DriversManagementContext(options, null, null, null);
