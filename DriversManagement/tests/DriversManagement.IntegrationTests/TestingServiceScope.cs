...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<DriversManagementContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<DriversManagementContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<DriversManagementContext, Task<T>> action)
