...
public class GetAllCompaniesTests : TestBase
{
    [Fact]
    public async Task get_all_companies_returns_success_using_valid_auth_credentials()
    {
        // Arrange
        ...
        // Act
        var result = await FactoryClient.GetRequestAsync(ApiRoutes.Companies.GetAll);
