...
public class GetInspectionListTests : TestBase
{
    [Fact]
    public async Task get_inspection_list_returns_success_using_valid_auth_credentials()
    {
        // Arrange
        ...
        // Act
        var result = await FactoryClient.GetRequestAsync(ApiRoutes.Inspections.GetList);
