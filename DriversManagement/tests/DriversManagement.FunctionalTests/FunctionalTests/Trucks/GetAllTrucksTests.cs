...
public class GetAllTrucksTests : TestBase
{
    [Fact]
    public async Task get_all_trucks_returns_success_using_valid_auth_credentials()
    {
        // Arrange
        ...
        // Act
        var result = await FactoryClient.GetRequestAsync(ApiRoutes.Trucks.GetAll);
